...
const en = {
  ...
  layers: {
    ...
    changeNote: "One credit. About fifteen seconds. The original stays as v1.",
    changeScoredNote: "One credit. The face is scored against your character — a miss is re-rendered free.",
    changeGo: "Change it",
