...
const en = {
  ...
  studio: {
    ...
    subtitle: "Pick a product, pick a proven shot, choose your star — get a contact sheet of four.",
    productsTitle: "Products",
    productsSubtitle: "Your catalog. Each product keeps its photos, name and logo — every Studio shoot starts from here.",
    stepProduct: "Product",
    stepShot: "Shot",
    stepStar: "Star & generate",
    addProduct: "Add product",
    editProduct: "Edit product",
    firstProductCta: "Add your first product",
    manageProducts: "Manage products",
    deleteProduct: "Delete product",
    namePlaceholder: "Product name — e.g. Aterra Bottle",
    photosLabel: "Product photos (up to 3)",
    addPhoto: "Add",
    logoLabel: "Logo (optional)",
    addLogo: "Add logo",
    replaceLogo: "Replace logo",
    logoHint: "Needed for the logo-on-apparel shot.",
    photosWord: "photos",
    logoWord: "logo",
    saveProduct: "Save product",
    saving: "Saving…",
    cancel: "Cancel",
    connectionError: "Connection hiccup — try again.",
    recipes: { "held-by-character": "Held by your character", "logo-apparel": "Logo on apparel", "product-hero": "Product hero", lifestyle: "Lifestyle scene" },
    recipeSubs: { "held-by-character": "the ad only Picacho makes", "logo-apparel": "verbatim mark, proven", "product-hero": "pedestal, rim light, no person", lifestyle: "styled scene, no person" },
    needsLogoHint: "This shot uses the logo — {name} doesn't have one yet.",
    productOnly: "Product only — no character in this shot",
    noCharacters: "No characters with a photo yet — create one first.",
    generateSheet: "Generate 4 shots",
    generating: "Shooting…",
    contactSheet: "Contact sheet — pick your keepers",
    sheetCost: "4 renders · 1 credit each",
    takeFailed: "This take didn't pass — the other takes continue.",
    sheetNote: "Every take also lands in History and Media like any render.",
  },
  nav: {
    generate: "Generate",
    templates: "Templates",
