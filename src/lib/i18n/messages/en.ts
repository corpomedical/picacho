...
const en = {
  ...
  community: {
    ...
    blockConfirm: "You won't see their posts any more. You can unblock them in Settings → Privacy.",
  ...
  settings: {
    ...
    usageDesc: "Your plan, what you have used this cycle, and how to change it.",
    supportDesc: "Tell us what is wrong, or ask for a hand.",
    ...
    fullNameLabel: "Name",
    renewsOn: "Your plan's credits reset on {date}.",
    bonusIncluded: "Your allowance includes {n} bonus credits.",
    bonusIncludedOne: "Your allowance includes 1 bonus credit.",
    purchaseHistoryTitle: "Credit purchases",
    purchaseHistoryEmpty: "No credit packs bought yet.",
    purchaseCredits: "{n} credits",
  ...
  credits: {
    ...
    currentBalanceOne: "You have 1 extra credit available.",
