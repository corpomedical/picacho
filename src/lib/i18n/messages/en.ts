...
const en = {
  ...
  mystique: {
    ...
    sub: "Drop a clip of someone performing — a dance, a line to camera, a walk. The acting, the timing and the sound stay. The person becomes your character.",
  ...
  serverText: {
    ...
    recastNeedsCast: "Choose who performs it first.",
