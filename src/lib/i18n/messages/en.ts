...
const en = {
  ...
  directorsCut: {
    ...
    lede: "Drop in raw footage and say what you want. Opus 5.5 cuts it, frames it and captions it.",
    testing: "Admins · not charged while in testing",
    footage: "Footage",
    addFootage: "Add footage",
    addHint: "MP4 · MOV · music too",
    remove: "Remove {name}",
    ...
    phase: {
      ...
      cutting: "Cutting the edit",
      checking: "Checking the cut",
      rendering: "Rendering",
      done: "Done",
