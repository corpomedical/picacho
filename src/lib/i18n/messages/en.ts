...
const en = {
  ...
  generate: {
    ...
    issueNeedsCharacterWithAttachment: "Your photo rides as a scene reference — the face comes from a character. Pick one, or switch to Veo for a character-free render.",
