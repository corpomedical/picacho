...
const en = {
  ...
  sets: {
    ...
    lookOnPhoto: "Keeps the design of the thing in this photo: drawn four ways round, placed and turned the way the set has it.",
    lookPhotos: "Reference photos",
    lookPhotoN: "Photo {n}",
    lookPhotoUpload: "Upload a reference photo…",
    lookPhotoUploading: "Checking the photo…",
    lookPhotoRemove: "Remove photo {n}",
    lookPhotoHint: "A photo of something in the set — the exact car, a sofa, a building. It's drawn four ways round and your shots keep its design. Not a person: your character comes from their own photos.",
    lookDropped: "The look couldn't be cut out this time, so this still was shot without it.",
    lookRefDropped: "The reference photo couldn't be drawn this time, so this still was shot without it.",
