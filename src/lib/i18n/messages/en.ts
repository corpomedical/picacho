...
const en = {
  ...
  sets: {
    ...
    reply: {
      ...
      replyReaderBusy: "That's a lot of messages in ten minutes; try again in a moment. Nothing changed.",
      ...
      chips: {
        ...
        turn: "Turned · {way}",
        turnWays: { left: "left", right: "right", around: "around" },
        facing: "Facing · {value}",
      ...
      cant: {
        ...
        weather: "Sets have no weather yet. Night or the Harbour 4am palette makes it moodier, free.",
        ...
        photo: "The chat can't take photos yet. A thing's photos go on its card; a character's outfit photos go on their character.",
