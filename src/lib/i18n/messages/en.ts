...
const en = {
  ...
  marketing: {
    ...
    home: {
      ...
      stat2: "0€",
      stat2Caption: "charged for failed generations — refunds are automatic, not a support ticket",
      stat3: "1 photo",
  ...
  tutorial: {
    ...
    s6p2: "Failed generations refund themselves automatically — including results the system detects as broken (like a blank frame). You only ever pay for what actually worked.",
    ...
    visRefunded: "Failed → refunded automatically",
