...
const en = {
  ...
  sets: {
    ...
    aimDown: "Tilt down",
    lookLabel: "Look",
    lookOn: "Keeps the objects and finishes of this still.",
    lookOnSame: "Keeps the objects and finishes of this still, and the outfit too unless you describe another.",
    lookOff: "Turn off",
    lookOffNote: "Off: each still designs the set's objects afresh.",
    lookUseLatest: "Match the latest still",
    lookFirst: "Your first still sets the look: the next ones keep its objects and finishes.",
