...
const en = {
  ...
  deleteAccountPage: {
    ...
    fromAppStep3: "Under Danger zone, choose Delete account and type your username (or your email address) to confirm.",
    ...
    subscriptionBody: "Deleting your account cancels a subscription bought on our website. A subscription bought through Google Play must be cancelled in the Play Store first (Play Store → Payments & subscriptions) — Picacho can't cancel it for you, and won't delete an account that is still being billed there.",
  ...
  settings: {
    ...
    generationDefaultsDesc: "The composer opens on these. You can still change anything for a single render.",
    ...
    soundHelp: "Models that can make a soundtrack will. Dialogue you add is unaffected.",
    ...
    notifyRenderReadyHelp: "Your video, image or layer stack is ready to open.",
    ...
    notifyLowCreditsHelp: "One heads-up per billing period when you're down to 5 credits or fewer.",
  ...
  push: {
    ...
    lowCreditsBody: "{n} left. Tap to see your plan and top-up options.",
  },
  serverText: {
