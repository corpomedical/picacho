...
const it = {
  ...
  generate: {
    ...
    anotherShotLoadFailed: "Impossibile caricare quella scena da riutilizzare — aprila dalla Cronologia e riprova.",
    anotherShotAttachFailed: "Impossibile allegare l'inquadratura precedente — allegala manualmente o riprova dalla Cronologia.",
    ...
    issueNeedsCharacter: "{model} richiede un personaggio con foto di riferimento — scegline uno o cambia modello.",
  ...
  history: {
    ...
    anotherShotCta: "Un'altra inquadratura su questo set",
