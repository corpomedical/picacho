...
const it = {
  ...
  generate: {
    ...
    issueNeedsCharacterWithAttachment: "La tua foto viaggia come riferimento di scena — il volto viene da un personaggio. Scegline uno o passa a Veo per un render senza personaggio.",
