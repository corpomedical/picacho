...
const it = {
  ...
  studio: {
    title: "Studio prodotto",
    subtitle: "Scegli un prodotto, uno scatto provato e la tua star — ricevi un provino da quattro.",
    productsTitle: "Prodotti",
    productsSubtitle: "Il tuo catalogo. Ogni prodotto conserva foto, nome e logo — ogni servizio dello Studio parte da qui.",
    stepProduct: "Prodotto",
    stepShot: "Scatto",
    stepStar: "Star e genera",
    addProduct: "Aggiungi prodotto",
    editProduct: "Modifica prodotto",
    firstProductCta: "Aggiungi il primo prodotto",
    manageProducts: "Gestisci prodotti",
    deleteProduct: "Elimina prodotto",
    namePlaceholder: "Nome del prodotto — es. Borraccia Aterra",
    photosLabel: "Foto del prodotto (fino a 3)",
    addPhoto: "Aggiungi",
    logoLabel: "Logo (facoltativo)",
    addLogo: "Aggiungi logo",
    replaceLogo: "Sostituisci logo",
    logoHint: "Serve per lo scatto con il logo sui capi.",
    photosWord: "foto",
    logoWord: "logo",
    ...
    recipes: { "held-by-character": "In mano al tuo personaggio", "logo-apparel": "Logo sui capi", "product-hero": "Hero di prodotto", lifestyle: "Scena lifestyle" },
    recipeSubs: { "held-by-character": "la pubblicità che solo Picacho fa", "logo-apparel": "marchio esatto, provato", "product-hero": "piedistallo, luce di contorno, senza persona", lifestyle: "scena ambientata, senza persona" },
    needsLogoHint: "Questo scatto usa il logo — {name} non ne ha ancora uno.",
    productOnly: "Solo prodotto — nessun personaggio in questo scatto",
    noCharacters: "Nessun personaggio con foto — creane uno prima.",
    generateSheet: "Genera 4 scatti",
    generating: "Sul set…",
    contactSheet: "Provino — scegli i migliori",
    sheetCost: "4 render · 1 credito ciascuno",
    takeFailed: "Questo scatto non è passato — gli altri continuano.",
    sheetNote: "Ogni scatto finisce anche in Cronologia e Media come ogni render.",
  },
  nav: {
    generate: "Genera",
    templates: "Modelli",
