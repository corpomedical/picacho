...
const EXACT: Record<string, keyof Messages["serverText"]> = {
  ...
  // The month's limiter refused with changes still in hand, or an unread count (step A4).
  "We couldn't check your Astra changes — try again in a moment.": "setEditCountUnread",
  ...
  "Your product's name, or a word ticked on its label, can't appear in an ad under our ad rules or your brand rules. On Press Tour, press \"Edit its card\", untick that word under \"Words on the label\" or change the name, then plan again.": "pressPlanRefusedLabelClaim",
  ...
  "This still couldn't be repainted under our content and ad rules, so it keeps the painting it had.": "pressStillRepaintRefused",
  ...
  "We couldn't paint your stills. A still that failed partway through painting was still charged.": "pressPaintFailedCharged",
  "One of your stills couldn't be shown under our content rules, so this ad stopped. A still that failed partway through painting was still charged.": "pressStillRefusedCharged",
  ...
  // Press Tour's filming, the press wall and the cut (lib/press-tour/
  // film-messages.ts, 2026-09-26): the Film and Re-film presses' answers,
  // the ad's blocker line while we film, check and cut, and why an ad
  // closed after filming.
  "Filming is busy. Try again in a few minutes. Nothing was charged. Your stills are saved.": "pressFilmBusy",
  "We couldn't start filming. Nothing was charged. Try again.": "pressFilmCouldntStart",
  "We couldn't start filming. Try again in a moment.": "pressFilmNotStarted",
  "Your free daily generation can't pay for filming an ad.": "pressFilmFreeSlot",
  "Every shot needs its still before filming. Repaint the one that's missing.": "pressFilmStillsMissing",
  "Your shots are being filmed. Try again in a few minutes.": "pressFilmCancelWait",
  "We're still finishing your cut, so this ad can't be closed now. If it isn't done within a day, it closes on its own.": "pressCutCancelWait",
  "Your shots aren't filmed yet.": "pressShotsNotFilmed",
  "That shot is being filmed. Wait for it to finish.": "pressShotBeingFilmed",
  "That take isn't ready yet.": "pressTakeNotReady",
  "That take isn't in this shot.": "pressTakeNotInShot",
  "That shot has been filmed again as many times as it can be. Keep a take or cut the shot.": "pressRefilmLimit",
  "Your ad needs at least one shot. Keep a take instead.": "pressCutLastShot",
  "Your cut is being made. Wait for it to finish.": "pressCutBeingMade",
  "None of your shots has a take to cut yet. Film one again.": "pressCutNothing",
  "We're filming your shots.": "pressBlockFilming",
  "We're checking your shots.": "pressBlockReadingShots",
  "We're cutting your ad.": "pressBlockCutting",
  "We're finishing your ad.": "pressBlockFinishing",
  "We couldn't finish the cut, and we're on it. Your shots are in History.": "pressCutStalled",
  "This ad's shots couldn't be shown under our content rules, so it stopped.": "pressFilmRefused",
  "This ad waited 7 days for your decision and was closed. Your filmed shots are in History.": "pressFilmExpired",
  "We couldn't finish your ad within a day. Your shots are in History, and our team has been told.": "pressCutLate",
  // Press Tour's posting (lib/social/messages.ts, 2026-09-26): the press
  // line's connect, preview and post answers, and a post's line after it
  // went (or didn't).
  "Posting isn't open on this account yet.": "pressPostingNotOpen",
  "Posting to this network is paused for the moment. Nothing was posted.": "pressPostingPaused",
  "Coming soon.": "pressComingSoon",
  "Posting straight to TikTok is in private testing. Save the video for TikTok instead.": "pressTikTokSaveInstead",
  "Private test mode: TikTok offers only \"Only me\", and the account must be private.": "pressTikTokTestModeNote",
  "Connect accounts on a computer. Posting through an account you connected works here too.": "pressConnectOnComputer",
  "Connecting this network isn't set up yet.": "pressConnectUnavailable",
  "Open Picacho at picacho.ai to connect accounts, then try again.": "pressConnectOtherSite",
  "That's a lot of connecting in an hour. Try again a little later.": "pressConnectLimit",
  "We couldn't connect that account. Try again.": "pressConnectFailed",
  "Connect an account to post here.": "pressNotConnected",
  "Reconnect this account to post.": "pressReconnectNeeded",
  "This ad isn't ready to post yet.": "pressCutNotReady",
  "The ad changed since you looked. Check it again, then post.": "pressCutChanged",
  "A shot that didn't match your product is still in this ad.": "pressCutWarningMismatch",
  "The text is too long for this network.": "pressTextTooLong",
  "That's too many hashtags for this network.": "pressTooManyHashtags",
  "Hashtags can use letters, numbers and _ only.": "pressHashtagInvalid",
  "Links can't go in posts to X yet. Put the link in your bio and write \"link in bio\".": "pressXNoLinks",
  "Link in bio: posts to X carry no links.": "pressXLinkNote",
  "This text can't be posted. Change it and try again.": "pressCaptionRefused",
  "This text breaks the ad rules: no invented reviews, no hidden sponsorship, no \"best\" or health claims. Change it and try again.": "pressCaptionRefusedAdRules",
  "We couldn't check the text just now. Try again in a moment.": "pressCaptionCheckUnavailable",
  "You posted this ad with almost the same words to this account recently. Change the caption or the cut.": "pressDuplicatePost",
  "Marked as made with AI": "pressAiLabelNote",
  "\"Made with AI\" is added to the text": "pressAiLabelNoteText",
  "Made with AI": "pressThreadsAiTag",
  "That's all the posts to this network for today. Try again tomorrow.": "pressDailyLimitNetwork",
  "Posting to X is closed for today. Try again tomorrow.": "pressXClosedToday",
  "That's a lot of posting in an hour. Try again a little later.": "pressPostRateLimit",
  "TikTok posts go out only when you press Post.": "pressScheduleTikTok",
  "Pick a time at least 5 minutes from now.": "pressScheduleTooSoon",
  "Pick a time within the next 30 days.": "pressScheduleTooFar",
  "That time doesn't look right. Pick it again.": "pressScheduleInvalid",
  "Your free ad can be posted once, to X.": "pressTrialXOnce",
  "Choose who can see this video.": "pressTikTokPrivacyRequired",
  "TikTok doesn't offer that choice for this account. Choose again.": "pressTikTokPrivacyNotOffered",
  "In test mode TikTok offers only \"Only me\".": "pressTikTokTestOnlyMe",
  "Branded content can't be set to \"Only me\".": "pressTikTokBrandedPrivate",
  "Branded content isn't available in test mode.": "pressTikTokBrandedTest",
  "This account turned that off in TikTok.": "pressTikTokInteractionOff",
  "This video is longer than this TikTok account can post.": "pressTikTokTooLong",
  "In test mode TikTok takes posts only from private accounts. Set your TikTok account to private, then try again.": "pressTikTokAccountPublic",
  "TikTok says this account can't post more right now. Try again later.": "pressTikTokCantPostNow",
  "Test posting to TikTok is full for today. Try again tomorrow.": "pressTikTokTestFull",
  "We couldn't reach TikTok just now. Try again in a moment.": "pressTikTokUnavailable",
  "By posting, you agree to TikTok's Music Usage Confirmation.": "pressTikTokDeclaration",
  "By posting, you agree to TikTok's Branded Content Policy and Music Usage Confirmation.": "pressTikTokDeclarationBranded",
  "It can take a few minutes to appear on your profile.": "pressTikTokAfterPost",
  "Going out now.": "pressPostSending",
  "Posted.": "pressPostPublished",
  "We couldn't confirm this went out. Check your profile before posting again.": "pressPostUnconfirmed",
  "Cancelled. Nothing was posted.": "pressPostCancelled",
  "This post is already going out, so it can't be cancelled.": "pressPostNotCancellable",
  "The network is busy right now. Nothing was posted. Pick a new time.": "pressNetworkBusy",
  "This account reached the network's posting limit for today. Nothing was posted. Pick a new time.": "pressNetworkLimitReached",
  "The network couldn't take this video. Nothing was posted.": "pressMediaRejected",
  "We couldn't send the video. Nothing was posted.": "pressUploadFailed",
  "The network turned this post down. Nothing was posted.": "pressPostRejected",
  "X turned this down as a repeat. Nothing was posted. Change the caption or the cut.": "pressXRepeatRejected",
  "The account was disconnected. Nothing was posted.": "pressConnectionGone",
  "Posting isn't open on this account any more. Nothing was posted.": "pressPostAccessLost",
  "What would post no longer matches what you approved, so nothing was posted.": "pressPostNoLongerMatches",
  "Something went wrong on our side. Nothing was posted.": "pressPostFailed",
  // What Press Tour says through Claude and ChatGPT (lib/mcp/press/
  // messages.ts, lib/mcp/auth.ts, api/mcp/route.ts's SPEND_LIMITED): the
  // model reads them in English and answers in the person's language; the
  // map lets any screen that shows one say it in theirs. And what Settings ›
  // Connected apps hears back from its Disconnect (lib/mcp/oauth/messages.ts).
  "Press Tour isn't available here right now.": "mcpPressOff",
  "Press Tour isn't open to this account in other apps yet.": "mcpPressTrialOnly",
  "Something went wrong starting that step, and it may have started anyway. Open the ad again to see where it is before pressing anything.": "mcpPressSpendUnsure",
  "plan_id is required: it comes from draft_ad_plan.": "mcpPlanIdRequired",
  "character_id is required: pick one from list_characters.": "mcpCharacterRequired",
  "Send product_id (from import_product or get_brand_kit) or the product's page address as product_url.": "mcpProductRequired",
  "url is required: the address of the product's page.": "mcpProductUrlRequired",
  "length_seconds must be 10, 15 or 30.": "mcpLengthInvalid",
  "networks must list one or more of: x, tiktok, instagram, threads.": "mcpNetworksInvalid",
  "decisions must list shots with a choice of \"approve\" or \"keep\".": "mcpDecisionsInvalid",
  "Paid steps are started from Picacho's card, with a tap. Ask the person to use the card.": "mcpNonceRequired",
  "That tap was already used. The card shows where the ad is now.": "mcpNonceUsed",
  "This card is out of date. It has been refreshed; check it and tap again.": "mcpNonceExpired",
  "That card belongs to a different ad. Open this ad's card and tap there.": "mcpNonceWrong",
  "This product needs its card set up in Picacho before an ad can be painted: tick the words printed on it and confirm you may advertise it.": "mcpProductNeedsSetup",
  "Picacho doesn't have this product yet. Read it with import_product, then the person confirms its card in Picacho.": "mcpProductNotFoundByUrl",
  "The product's card is drafted. The person confirms it in Picacho (the words on the label, and that they may advertise it) before an ad can be painted.": "mcpProductDraftReady",
  "The product's card is confirmed and ready for an ad.": "mcpProductReady",
  "Filming isn't open here yet. The approved stills are kept; filming continues in Picacho.": "mcpFilmingInPicacho",
  "Nothing was posted. Posting happens on Picacho's press line, where the person checks each post and sends it.": "mcpPostInPicacho",
  "The ad isn't finished yet. The chosen networks are saved for when it is.": "mcpPostNotReady",
  "Face and product, checked on every still": "mcpChecksLine",
  "If a filmed shot doesn't match, you choose: keep it, cut it, or film it again at the normal price.": "mcpPolicyLine",
  "The ad is being planned.": "mcpStageDraft",
  "The plan is ready. Nothing is painted yet: stills come first, then the person's OK.": "mcpStagePlanned",
  "The stills are being painted.": "mcpStagePainting",
  "The stills are being checked.": "mcpStageCheckingStills",
  "The stills are painted and checked. The person approves or keeps each one on the card.": "mcpStageAwaitingApproval",
  "The shots are being filmed.": "mcpStageAnimating",
  "The filmed shots are being checked.": "mcpStageCheckingShots",
  "The ad is being cut together.": "mcpStageAssembling",
  "The ad is being finished.": "mcpStageSigning",
  "The ad is ready. Posting happens on Picacho's press line.": "mcpStageReady",
  "This ad stopped.": "mcpStageFailed",
  "This ad was stopped.": "mcpStageCancelled",
  "This ad waited too long for a decision and was closed.": "mcpStageExpired",
  "Connect your Picacho account to use this.": "mcpSignInNeeded",
  "Your Picacho connection has expired or was removed. Connect again.": "mcpSignInExpired",
  "We couldn't check your Picacho connection just now. Try again in a moment.": "mcpUnavailable",
  "This app needs permission to do that. Connect again and allow it.": "mcpScopeNeeded",
  "That's a lot of paid steps in a short time. Try again a little later.": "mcpSpendLimited",
  "That app isn't connected to this account.": "connectedAppsNotFound",
  "We couldn't disconnect that app just now. Try again.": "connectedAppsFailed",
  "Your session expired. Sign in again.": "connectedAppsSession",
};
...
const PATTERNS: {
  ...
  // Press Tour's press wall and the 24 h rule (lib/press-tour/
  // film-messages.ts blockDecideShot, cutLateRefunded), and a paid step
  // through Claude or ChatGPT that the account can't cover
  // (lib/mcp/press/messages.ts shortOfCredits).
  {
    re: /^Decide on shot (\d+) for your cut$/,
    key: "pressBlockDecideShot",
    params: (m) => ({ shot: m[1] }),
  },
  {
    re: /^We couldn't finish your ad within a day\. The (\d+) credits for filming went back, and your shots are in History\.$/,
    key: "pressCutLateRefunded",
    params: (m) => ({ credits: m[1] }),
  },
  {
    re: /^This step needs (\d+) credits; the account has (\d+)\.$/,
    key: "mcpShortOfCredits",
    params: (m) => ({ needed: m[1], have: m[2] }),
  },
];
