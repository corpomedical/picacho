...
export const RELEASES: Release[] = [
  {
    ...
    items: [
      ...
      "Admin → Users now shows sign-in activity for every user: last login (date and time), last seen, time on site, signed-in device count, and a live \"online now\" dot — as tidy columns in the list and a dedicated Activity card on each user's page. Times display in your own timezone, not the server's.",
