...
export const RELEASES: Release[] = [
  {
    ...
    items: [
      ...
      "Sent prompts in the Generate chat now show a timestamp and a copy button underneath (revealed on hover on desktop, always visible on touch) — same pattern as Claude\u2019s chat. Older messages include the date, not just the time.",
