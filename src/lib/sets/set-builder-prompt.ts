...
- An object's position is the CENTRE of its shape; an object resting on the ground has position y = size y / 2. rotation is in degrees, applied X then Y then Z. A positive X rotation turns +Y toward +Z: an upright's top leans toward +Z, and a flat panel's +Z edge dips. A positive Y rotation turns +Z toward +X, as facingDeg does. A positive Z rotation turns +X toward +Y. A sloped panel (a windscreen, a bonnet, a ramp) is a flat box tilted this way: check which edge rises before you choose the sign.
...
- Every vehicle shows which way it faces: glowing white headlights (emissive) at its front, red tail lights (emissive) at its back; its bonnet slopes down toward the front and its windscreen leans back from the bonnet to the roof.
