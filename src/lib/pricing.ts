...
export const PRICING_TIERS = [
  ...
  {
    id: "elite",
    // 424 -> 399 (15% -> 20% off) on 2026-08-30, credits 600 -> 750 on
    // 2026-08-31 — see PLAN_LIMITS.elite for the full arithmetic of both
    // moves. Annual has no Stripe price id of its own — checkout-core builds
    // it inline as annualPrice * 12 — so this number is the only place the
    // annual price lives.
    annualPrice: 399,
    name: "Elite",
    price: 499,
    ...
    highlight: false,
    features: [
      "750 credits / month ≈ 750 standard videos, or 375 premium ones",
