...
export const SRC_FILES = [
  ...
  "src/lib/generations/policy-log.ts",
  ...
  "src/lib/generations/providers/image-references.ts",
  "src/lib/generations/providers/openai-images.ts",
  "src/lib/generations/providers/fal-image.ts",
  "src/lib/generations/providers/openai.ts",
  "src/lib/generations/providers/refusal-messages.ts",
